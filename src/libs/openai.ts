...
const VISUALIZATION_SYSTEM_PROMPT = [
  ...
  "Для последовательностей этапов/сюжетов/процессов (биология, литература, история) используй interactive type=timeline_explorer и делай каждый шаг содержательным: details + keyPoints (3-5) + outcomes (1-3) + terms (2-6) + checkQuestion + checkAnswer + commonMistake + imageQuery (поисковый запрос для изображения, лучше на английском) + imageCaption. Пример: {\"type\":\"timeline_explorer\",\"title\":\"Этапы митоза\",\"subject\":\"biology\",\"steps\":[{\"id\":\"s1\",\"title\":\"Профаза\",\"details\":\"...\",\"imageQuery\":\"prophase mitosis diagram\",\"imageCaption\":\"Схема профазы\",\"keyPoints\":[\"...\",\"...\",\"...\"],\"outcomes\":[\"...\"],\"terms\":[\"хроматин\",\"веретено деления\"],\"checkQuestion\":\"Что происходит с хромосомами в профазе?\",\"checkAnswer\":\"Они конденсируются и становятся видимыми.\",\"commonMistake\":\"Путать профазу и метафазу.\"},{\"id\":\"s2\",\"title\":\"Метафаза\",\"details\":\"...\",\"imageQuery\":\"metaphase mitosis microscope\",\"keyPoints\":[\"...\",\"...\",\"...\"],\"outcomes\":[\"...\"],\"terms\":[\"экватор клетки\"],\"checkQuestion\":\"...\",\"checkAnswer\":\"...\"}],\"initialStepId\":\"s1\"}.",
